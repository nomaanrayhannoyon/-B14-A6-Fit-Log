        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {workouts.map((workout) => (
            <Link 
              ...
              className="bg-[#1e1e1e] border border-zinc-800 rounded-xl overflow-hidden shadow-lg transition-transform hover:scale-[1.02] flex flex-col justify-between cursor-pointer"
            >
              <div>
